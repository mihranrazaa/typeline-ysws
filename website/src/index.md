...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: RSVP
      link: https://typeline.fillout.com/rsvp

customMetaTitle: Typeline

features:
  - title: Tracking
    details: How we will track your work to avoid fraud(draft)
    ...
    linkText: Info for tracking
  - title: Examples
    details: Few Examples to give you an idea of what we expect from you :) . (draft)
    icon: <svg height="24" width="24" viewBox="0 -960 960 960" fill="var(--vp-c-indigo-2)" xmlns="http://www.w3.org/2000/svg"><path d="M440-120v-240h80v80h320v80H520v80h-80Zm-320-80v-80h240v80H120Zm160-160v-80H120v-80h160v-80h80v240h-80Zm160-80v-80h400v80H440Zm160-160v-240h80v80h160v80H680v80h-80Zm-480-80v-80h400v80H120Z"/></svg>
    link: /docs/guides/getting-started
    linkText: Examples
  - title: Ideas
    details: Bring your own Ideas what you are interested about..(draft)
